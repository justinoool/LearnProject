...
public interface RouterHub {
     ...
     * DEMO1分组
     */
    String DEMO1_SERVICE_ZHIHUINFOSERVICE = DEMO1 + SERVICE + "/ZhihuInfoService";

    String DEMO1_MAINACTIVITY = DEMO1 + "/MainActivity";
    String DEMO1_DETAILACTIVITY = DEMO1 + "/DetailActivity";
